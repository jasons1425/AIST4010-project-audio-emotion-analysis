...
fig, ax = plt.subplots()
ax.plot(labels_aro.cpu(), labels_aro.cpu(), label="Ideal fit")
ax.scatter(labels_aro.cpu(), preds_aro.cpu(), label="Predictions", color='y')
ax.set_title("DenseNet121 - Valence Predictions against True Valence Level")
