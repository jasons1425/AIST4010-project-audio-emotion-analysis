...
from baseline.resnet.resnet import ResNetSpecModel
...
model = ResNetSpecModel(resnet34, 512, 1, fcs=FC, dropout=DROPOUT).half().to(device)
...
torch.save(model.state_dict(), f"resnet_dominance.pth")
