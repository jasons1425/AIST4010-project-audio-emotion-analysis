...
train_loader = get_loader(train_data, train_labels[:, 2].reshape(-1, 1), batch_size=BATCH)
valid_loader = get_loader(valid_data, valid_labels[:, 2].reshape(-1, 1), batch_size=BATCH)
...
torch.save(model.state_dict(), f"spec_dominance.pth")
