...
train_loader = get_loader(train_data, train_labels[:, 1].reshape(-1, 1)/9, batch_size=BATCH)
valid_loader = get_loader(valid_data, valid_labels[:, 1].reshape(-1, 1)/9, batch_size=BATCH)
