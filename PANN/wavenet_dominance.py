...
# model preparation
# lr=1e-3, batch=16, 30 epochs, 159 m 18 s, 0.0194, fcs=[2048]
# lr=1e-3, batch=16, 30 epochs, 161 m 12 s, 0.0165, fcs=[2048]
sr = 22050
...
with open("pann_dominance_loss.npy", 'wb') as f:
    np.save(f, np.array(losses['valid']))
torch.save(model.state_dict(), f"pann_dominance.pth")
